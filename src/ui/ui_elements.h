...
static unsigned int                                                                 \
bagl_ui_##name##_screen_button(unsigned int button_mask,                            \
