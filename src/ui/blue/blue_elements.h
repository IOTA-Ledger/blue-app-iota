...
// TODO remove
#define INVISIBLE_BUTTON(x, y, w, h, callback)                                 \
  {                                                                            \
    {BAGL_NONE _TOUCHABLE, 0x00, x, y, w, h, 0, 0, BAGL_FILL, 0, 0, 0, 0},     \
        NULL, 0, 0, 0, callback, NULL, NULL,                                   \
  }
