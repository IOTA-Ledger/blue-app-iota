...
var WConverter      = require("../crypto/converter/words");
...
//-- adding to find easier
var kerlTest = function () {
  var kerl = new Kerl();
  kerl.initialize();

  // Address trits
  var addressTrits = Converter.trits("PETERPETERPETERPETERPETERPETERPETERPETERPETERPETERPETERPETERPETERPETERPETERPETERR");
  console.log('Address: ', addressTrits)
  var words = WConverter.trits_to_words(addressTrits)
  console.log('word conversion\n\n', WConverter.words_to_trits(words) + "\n\n");
...
return 0;
  ...
  var checksum = Converter.trytes( checksumTrits );
  console.log(`Test PETER Checksum: ${checksum}`);
}
