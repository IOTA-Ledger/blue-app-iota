...
function IOTA(settings) {
    ...
    normalizedBundleHashTest()
}

function normalizedBundleHashTest() {
  var hash = Converter.trits("MM9999999999999999999999999999999999999999999999999999999999999999999999999999999");
  hash = Converter.trytes(hash);
  var normalized = Bundle.prototype.normalizedBundle (hash);
  console.log('normalized', normalized);

  // This doesn't work
  // var normalizedTrits = Converter.trits(normalized);
  // console.log('normalizedTrits', WConverter.trits_to_words(normalizedTrits));
}
